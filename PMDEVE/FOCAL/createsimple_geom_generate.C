...
// Modified for general geometry files: Shyam 22/08/2016
// Just put ge file : here I have used "geometry.root"
...
void createsimple_geom_generate(char *detectorName="PMD", int runNumber=0)
{
   ...
   // gGeoManager = AliGeomManager::GetGeometry();
    ...
    for(int i=0;i<detectorsList.size();i++)
    {
        ...
        {
            eve_tnode->SaveExtract(Form("./simple_geom_%s.root",currentDetector),
