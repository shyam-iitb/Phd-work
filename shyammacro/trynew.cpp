...
//-------------Setting-----------------------------------
     ...
     //   p1->SetLogy();
        ...
        TString quantity="NIEL [KeV/cm^{3}]"; //Select==>DPA, NIEL [KeV/cm^{3}], DOSE [GeV/g], Frankel Pairs
...
//=========Graph and Plotting==============================
     ...
     if(quantity=="NIEL [KeV/cm^{3}]"){
         y[m]=b[m]*1.0e6;
         y1[m]=c[m]*1.0e6;
         y[m]=y[m]*500*5.9999998658895494e-005;
         y1[m]=y1[m]*500*5.9999998658895494e-005;        
     }
	...
	mg->GetYaxis()->SetTitle(Form("%s", quantity.Data()));
        ...
        if((material=="GaN" || material=="Ge") && quantity=="NIEL [KeV]"){
        mg->GetYaxis()->SetRangeUser(0.0,120.0);
}
...
//===========Print all mean======================================
	...
	std::cout<<"Mean="<<mean1<<std::endl;
        std::cout<<"Integral="<<integral1<<std::endl;
        std::cout<<"Sigma="<<sigma1<<std::endl;
        std::cout<<"Integral is="<<mean1*integral1*5.9999998658895494e-005<<std::endl;
	Std::cout<<"+++++++++++++Results++++++++++++"<<std::endl;
	std::cout<<"Mean="<<mean2<<std::endl;
        std::cout<<"Sigma="<<sigma2<<std::endl;
        std::cout<<"Integral is="<<mean2*integral2*5.9999998658895494e-005<<std::endl;
	Std::cout<<"+++++++++++++Results++++++++++++"<<std::endl;
	std::cout<<"Mean="<<mean3<<std::endl;
        std::cout<<"Sigma="<<sigma3<<std::endl;
        std::cout<<"Integral is="<<mean3*integral3*5.9999998658895494e-005<<std::endl;
	Std::cout<<"+++++++++++++Results++++++++++++"<<std::endl;
	std::cout<<"Mean="<<mean4<<std::endl;
        std::cout<<"Sigma="<<sigma4<<std::endl;
        std::cout<<"Integral is="<<mean4*integral4*5.9999998658895494e-005<<std::endl;
	Std::cout<<"+++++++++++++Results++++++++++++"<<std::endl;
	std::cout<<"Mean="<<mean5<<std::endl;
        std::cout<<"Sigma="<<sigma5<<std::endl;
        std::cout<<"Integral is="<<mean5*integral5*5.9999998658895494e-005<<std::endl;
	Std::cout<<"+++++++++++++Results++++++++++++"<<std::endl;
	std::cout<<"Mean="<<mean6<<std::endl;
        std::cout<<"Sigma="<<sigma6<<std::endl;
        std::cout<<"Integral is="<<mean6*integral6*5.9999998658895494e-005<<std::endl;
	Std::cout<<"+++++++++++++Results++++++++++++"<<std::endl;
	std::cout<<"Mean="<<mean7<<std::endl;
        std::cout<<"Sigma="<<sigma7<<std::endl;
        std::cout<<"Integral is="<<mean7*integral7*5.9999998658895494e-005<<std::endl;
	Std::cout<<"+++++++++++++Results++++++++++++"<<std::endl;
	std::cout<<"Mean="<<mean8<<std::endl;
        std::cout<<"Sigma="<<sigma8<<std::endl;
        std::cout<<"Integral is="<<mean8*integral8*5.9999998658895494e-005<<std::endl;
	Std::cout<<"+++++++++++++Results++++++++++++"<<std::endl;
	std::cout<<"Mean="<<mean9<<std::endl;
        std::cout<<"Sigma="<<sigma9<<std::endl;
        std::cout<<"Integral is="<<mean9*integral9*5.9999998658895494e-005<<std::endl;
	Std::cout<<"+++++++++++++Results++++++++++++"<<std::endl;
	std::cout<<"Mean="<<mean10<<std::endl;
        std::cout<<"Sigma="<<sigma10<<std::endl;
        std::cout<<"Integral is="<<mean10*integral10*5.9999998658895494e-005<<std::endl;
	Std::cout<<"+++++++++++++Results++++++++++++"<<std::endl;
	std::cout<<"Mean="<<mean11<<std::endl;
        std::cout<<"Sigma="<<sigma11<<std::endl;
        std::cout<<"Integral is="<<mean11*integral11*5.9999998658895494e-005<<std::endl;
	Std::cout<<"+++++++++++++Results++++++++++++"<<std::endl;
	std::cout<<"Mean="<<mean12<<std::endl;
        std::cout<<"Sigma="<<sigma12<<std::endl;
        std::cout<<"Integral is="<<mean12*integral12*5.9999998658895494e-005<<std::endl;
	Std::cout<<"+++++++++++++Results++++++++++++"<<std::endl;
	std::cout<<"Mean="<<mean13<<std::endl;
        std::cout<<"Sigma="<<sigma13<<std::endl;
        std::cout<<"Integral is="<<mean13*integral13*5.9999998658895494e-005<<std::endl;
	Std::cout<<"+++++++++++++Results++++++++++++"<<std::endl;
	std::cout<<"Mean="<<mean14<<std::endl;
        std::cout<<"Sigma="<<sigma14<<std::endl;
        std::cout<<"Integral is="<<integral14<<std::endl;
        std::cout<<"Integral is="<<mean14*integral14*5.9999998658895494e-005<<std::endl;
}
  // -----  Finish   -------------------------------------------------------
	  timer.Stop();
