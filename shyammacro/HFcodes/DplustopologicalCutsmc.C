...
void DplustopologicalCuts()
{
 ...
 //--------------Reading the file--------------------
    TString filename="AnalysisResultsmc.root";
    TFile* f = new TFile(filename,"READ");
    if(!f->IsOpen()){
    cout<<"File "<<filename.Data()<<" not found"<<endl;
    return;
    }
  TString DirectoryoutputSE="pPb_DplusHadCorr_SE_wTrkEff_wDkEff_PoolbyPool_Pass4SE";
  TString objectoutputSE="coutBasicPlots_pPb_DplusHadCorr_SE_wTrkEff_wDkEff_PoolbyPool_Pass4SE";
  ...
  TString phi="AssoTrkPhi_MC"; 
  TString eta="AssoTrkEta_MC"; 
  TString pt="AssoTrkPt_MC"; 
  TString mphi="h2Dplus_MassVsPhiBin_MC";
  TString meta="h2Dplus_MassVsEtaBin_MC";
  ...
  hEta->Draw("hist");
  c1->SaveAs("DplusCuts/Basiccuts1Pass4_MC.png");
  c1->SaveAs("DplusCuts/root/Basiccuts1Pass4_MC.root");
  c2->cd(1);
  ...
  hmulti->Draw("colz");
  c2->SaveAs("DplusCuts/Basiccuts2Pass4_MC.png");
  c2->SaveAs("DplusCuts/root/Basiccuts2Pass4_MC.root");
//--------Topological cuts for Pt Bins---------
 ...
 for(Int_t i=2;i<n;i++){ //n Pt Bins
          ...
          TString ptdaukaon=Form("hPtDaughterKaon_Bin%d_MC", i);
	  TString ptdaupion1=Form("hPtDaughterPion1_Bin%d_MC", i);
	  TString ptdaupion2=Form("hPtDaughterPion2_Bin%d_MC", i);
          TString d0daukaon=Form("hd0DaughterKaon_Bin%d_MC", i);
          TString d0daupion1=Form("hd0DaughterPion1_Bin%d_MC", i);
          TString d0daupion2=Form("hd0DaughterPion2_Bin%d_MC", i);
          TString dist12=Form("hdist12_Bin%d_MC", i);
          TString dist23=Form("hdist23_Bin%d_MC", i);
          TString sigmaV=Form("hSigmaVert_Bin%d_MC", i);
	  TString CosPA=Form("hCosPA_Bin%d_MC", i);
	  TString CosPAXY=Form("hCosPAXY_Bin%d_MC", i);
          TString Ndecaylen=Form("hNDeacyLenXY_Bin%d_MC", i); 
	  TString decaylen=Form("hDecayLen_Bin%d_MC", i);
	  TString decaylenxy=Form("hDecayLenXY_Bin%d_MC", i);
          TString dca=Form("hDCA_Bin%d_MC", i);
	  TString d0square=Form("hd0square_Bin%d_MC", i);
          TString drapidty=Form("hDrapidty_Bin%d_MC",i);
          TString CosPAvsdPS=Form("hCosPAvsdPS_Bin%d_MC", i);
          TString d0KvsPtK=Form("hd0DaughterKaonvsPtK_Bin%d_MC", i);
          TString d0Pi1vsPtPi1=Form("hd0DaughterPion1vsPtPi1_Bin%d_MC", i); //here should be hd0 instead of hPt
          TString d0Pi2vsPtPi2=Form("hd0DaughterPion2vsPtPi2_Bin%d_MC", i); //here should be hd0 instead of hPt
	...
	//  TH1F *hdrapidty=(TH1F*)DCutlist->FindObject(drapidty);
	  ...
	  hd0Pi2vsPtPi2->SetTitleSize(0.05,"Y");
          ...
          canvas1[i]->SaveAs(Form("DplusCuts/Dpluscutsc1Pass4%d_MC.png",i));
          canvas1[i]->SaveAs(Form("DplusCuts/root/Dpluscutsc1Pass4%d_MC.root",i));
          canvas2[i]->SaveAs(Form("DplusCuts/Dpluscutsc2Pass4%d_MC.png",i));
          canvas2[i]->SaveAs(Form("DplusCuts/root/Dpluscutsc2Pass4%d_MC.root",i));
          canvas3[i]->SaveAs(Form("DplusCuts/Dpluscutsc3Pass4%d_MC.png",i));
          canvas3[i]->SaveAs(Form("DplusCuts/root/Dpluscutsc3Pass4%d_MC.root",i));
          canvas4[i]->SaveAs(Form("DplusCuts/Dpluscutsc4Pass4%d_MC.png",i));
          canvas4[i]->SaveAs(Form("DplusCuts/root/Dpluscutsc4Pass4%d_MC.root",i));
       }
